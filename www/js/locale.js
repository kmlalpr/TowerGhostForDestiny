tgd.locale = {
    tr: {
        unable_create_loadout_for_type: "Bu item türü ile teçhizat oluşturmak şu anda mümkün değil.",
        unable_to_create_loadout_for_bucket: "Bu slota 10 dan fazla öğe ile bir teçhizat oluşturamazsın: ",
        unable_to_move_bucketitems: "Seçtiğin öğeler bu uygulama ile aktarılamaz.",
        this_icon: "Bu ikon ",
        pick_a_set: "Bu seçeneği seçmeden önce bir set seçiniz",
        error_loading_inventory: "Envanter yüklenirken hata oluştu ",
        whats_new_title: "Tower Ghost for Destiny güncellemeleri",
        itemDefs_undefined: "Öğe tanımlanamadı. Lütfen bu problemi GitHub sayfamdan ingilizce olarak bildiriniz.",
        invalid_transfer_amount: "Geçersiz miktar girildi: ",
        normalize_title: "Bölüştür - Bir öğeyi karakterlere eşit olarak dağıtır.",
        transfer_amount: "Aktarım Miktarı",
        transfer_all: "Hepsi",
        transfer_one: "Bir Adet",
        cancel: "Vazgeç",
        cannot_unequip: "Bu öğeyi bırakmayı denemek için yerie gelebilecek öğe yok ",
        unable_unequip: "Öğeyi bırakmak mümkün değil ",
        cannot_equip: "Öğeyi donatmayı denerken bilinmeyen bir hata oluştu ",
        ...
        menu_view_armor: "Zırh",
        menu_view_general: "Genel",
        menu_view_options: "Ayarları Görüntüle",
        menu_shareurl: "URL Yi arkadaşlarınla paylaş",
        menu_autorefresh: "Otomatik yenile",
        ...
        menu_usexbox: "XBox Hesabı Kullan",
        menu_useps: "PlayStation Hesabı Kullan",
        menu_set: "Ayarla",
        menu_set_showmissing: "Eksik öğeleri göster",
        menu_set_showduplicates: "Çoğaltılan öğeleri göster",
        menu_tier: "Sıra",
        menu_progress: "Ilerleme",
        menu_progress_1: "Tamamlanmamış XP",
        menu_progress_2: "Tam XP",
        menu_progress_3: "Maksimum",
        menu_damage: "Hasar",
        menu_weapons: "Silahlar",
        language_pack_downloaded: "Dil paketi indirildi. Lütfen programı kapatıp açın ve değişiklikleri görün.",
        vo_number_of_columns: "Vault durumu",
        ...
        login_authenticating_pt2: "Eğer yükleme ekranı 2 dakikadan fazla durduysa,lütfen şu linke tıklayın ",
        login_authenticating_pt3: "giriş yapmayı tekrar deneyin. Eğer problem devam ederse,programı yeniden yükleyin.",
        login_title: "Tower Ghost For Destiny ye Hoş Geldiniz!",
        login_instructions: "Başlamak için Bungie.Net Hesabına giriş yapman gerekiyor:",
        login_help: "Yükleme ekranını bekleyin,tamamlandığında TGD Sizi programın anasayfasına yönlendirecek.Sabır!",
        movepopup_move: "Taşı",
        ...
        inventory_armor: "Zırh",
        inventory_subclasses: "Sub Klaslar",
        inventory_general: "Genel",
        ...
        loadouts_instructions: "Teçhizatta öğe yok,öğeye tıkla ve ekle",
        loadouts_instructions_contd: "donan.",
        loadouts_mobile: "tut",
        loadouts_desktop: "kontrol",
        loadouts_transferred: "<strong>Öğe(ler) başarı ile transfer edildi,hayırlı uğurlu olsun!</strong><br> Eğer bu kolaylığı beğendiysen,bağışı unutma! <a style=\"color:#3080CF; cursor:pointer;\" class=\"donateLink\" target=\"_system\">buy me a beer</a>",
        loadouts_to_transfer: " Aktarılacak",
        loadouts_no_transfer: " aktarılmayacak",
        loadouts_no_replacement: " aktarılmayacak. Yerine geçebilecek bir öğe yok.",
        loadouts_outofspace: " aktarılmayacak, yer yok ",
        loadouts_invalidbucket: " Seçtiğiniz öğelerden dolayı aktarılmayacak: ",
        loadouts_alreadythere_pt1: " zaten içerisinde ",
        loadouts_alreadythere_pt2: "'zaten seçtiğiniz öğeler arasında ",
        loadouts_swap: " ile takas yapılacak ",
        loadouts_to_moveequip: " taşınacak ve donatılacak.",
        loadouts_to_equip: " Donatılacak.",
        ...
        tier_exotic: "Exotic",
        paypal_code: "TR",
        menu_destinystatus: "DestinyStatus Raporla",
        language_text: "Bu seçenek programın dilini değiştirecek. Gelecekte daha fazla dil desteği olacak inşallah!.",
        menu_settings: "Ayarlar",
        text_shareurl: "Inventoriniz URL PAYLAŞ seçeneği ile tekrar güncellenebilir..",
        donation_title: "Tower Ghost For Destiny İçin Bağış!",
        donation_instructions: "Bu program Destiny için bağışlanmış tamamen ücretsiz bir programdır.Eğer sağladığımız hizmet hoşunuza gittiyse lütfen bizi bağışlarınız ile destekleyiniz.."
    },
    es: {
